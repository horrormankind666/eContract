...
<body>
         <center><div class='card-panel grey lighten-5'>
                                <div class='grey-text text-darken-4'>
                                    <div class='section'>
                                         <p class='center red-text'><b><u>ข้อแนะนำเบื้องต้น เมื่อไม่สามารถเข้าระบบทำสัญญาอิเล็กทรอนิกส์ได้</u></b></p>
                                        <div class='col s12 m12 l12'><img src='images/webbrowsers_icons.png' alt='' class='responsive-img' /></div>
                                    ...
                                    <table class="logos">
                                        ...
                                        <td class="b bi">
                                        <a class="l" href="http://windows.microsoft.com/en-US/internet-explorer/downloads/ie" target="_blank" onmousedown="countBrowser('i')"><span class="bro">Edge</span>
