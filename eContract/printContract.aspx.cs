...
namespace eContract {
    public partial class PrintContract : Page {
        protected void Page_Load(
            ...
            //string parentType = "student";
            //login.StudentCode = "6103092";
            //string studentID = "STD256103342";
            string parentType = login.UserType; //type: M, F, student
            ...
            switch (action) {
                case "printContract":
                    //Response.Write("printContract");
                    //A
                    PrintContractStd(studentID, login.StudentCode);
                    break;
                case "printConsent":
                    //Response.Write("printConsent");
                    //B
                    PrintGarrantee(studentID, parentType, login.StudentCode);
                    break;
                case "printWarrant":
                    //Response.Write("printWarrant");
                    //C
                    PrintWarrant(studentID, parentType, login.StudentCode);
                    break;
                case "printAll":
                    //Response.Write("printAll");
                    //A, B, C
                    PrintAll(studentID, parentType);
                    break;
            }
        }
        ...
        */
        public void PrintContractStd (
            ...
            if (contract == " - ") {
                ...
                string provice = Myconfig.CvEmpty(stdInfo.ProvinceNameTH, " - ");
                string zipcode = Myconfig.CvEmpty(stdInfo.Zipcode, " - ");
                string phone = Myconfig.CvEmpty(stdInfo.PhoneNumberStd, " - ");
                string programCode = Myconfig.CvEmpty(stdInfo.ProgramCode, " - "); //programCode = "DTDSB";
                ...
                if (programCode == "SIMDB") {
                    ...
                    if (statusContract == "OLD") {
                        ...
                        y = 460;
                        cb.SetFontAndSize(bf, 15);
                        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, provice, 95, y, 0); //จังหวัด
                        ...
                        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, provice, 299, y, 0); //จังหวัด
                ...
                if (programCode == "RAMDB") {
                    ...
                    if (statusContract == "OLD") {
                        ...
                        y = 417;
                        cb.SetFontAndSize(bf, 15);
                        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, signCEO, 210, y, 0);
                ...
                if (programCode == "PYPYB") {
                    ...
                    y = 382;
                    cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, "รักษาการแทนอธิการบดีมหาวิทยาลัยมหิดล", 335, y, 0); //ตำแหน่งอธิการบดี
                ...
                if (programCode == "DTDSB") {
                    ...
                    if (statusContract == "OLD") {
                        ...
                        y = 465;
                        cb.SetFontAndSize(bf, 15);
                        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, provice, 120, y, 0); //จังหวัด
                ...
                if (programCode == "RANSB") {
                    ...
                    y = 529;
                    cb.SetFontAndSize(bf, 15);
                    cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, provice, 90, y, 0); //จังหวัด
                ...
                if (programCode == "NSNSB") {
                    ...
                    if (quotaCode == "") {
                        ...
                        y = 529;
                        cb.SetFontAndSize(bf, 15);
                        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, provice, 80, y, 0); //จังหวัด
                        cb.ShowTextAligned(PdfContentByte.ALIGN_LEFT, zipcode, 280, y, 0); //รหัสไปรษณีย์
        ...
        */
        public void PrintGarrantee(
            ...
            if (garrantee == " - ") {
                ...
                string consentBy = ctInfo.ConsentBy;
                string programCodeExtra;
                //strign studentCode = Myconfig.CvEmpty(stdInfo.StudentCode, " - ");
                string stdNameTH = Myconfig.CvEmpty(stdInfo.StdNameTH, " - ");
                //string programNameTH = Myconfig.CvEmpty(stdInfo.ProgramNameTH, " - ");
                string programCode = Myconfig.CvEmpty(stdInfo.ProgramCode, " - ");
                string idCard;
        ...
        public void PrintAll(
            ...
            //PrintContractStd(studentID); //A
            //PrintGarrantee(studentID, parentType); //B
            //PrintWarrant(studentID, parentType); //C
            ContractInfo ctInfo = new ContractInfo(studentID);
            string file1 = Myconfig.CvEmpty(ctInfo.ContractPath, " - ");
            string file2 = Myconfig.CvEmpty(ctInfo.GarranteePath, " - ");
            string file3 = Myconfig.CvEmpty(ctInfo.WarranPath, " - ");
            ...
            string a = ("your images/" + DirectoryName + ".zip");
            ...
            */
            ...
            PdfCopy writer = new PdfCopy(document, new FileStream(Server.MapPath("~/ElectronicContract/") + "a.pdf", FileMode.Create)); //แบบไม่สร้างไฟล์ใน server
            ...
            FileStream sourceFile = new FileStream(Server.MapPath("~/ElectronicContract/") + "a.pdf", FileMode.Open);
            long FileSize;
            FileSize = sourceFile.Length;
            byte[] getContent = new byte[(int)FileSize];
