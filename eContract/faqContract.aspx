...
<body class="" style="background-color: #F2F0EF">
    ...
    <div class="container">
		...
		<div class="tab-content">
            ...
            <div id="tab5">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <!-- จบ 1. บิดาที่จดทะเบียนรับรองบุตร -->
                        ...
                        <!-- จบ 2. บุคคลที่จดทะเบียนรับนักศึกษาเป็นบุตรบุญธรรม -->
                        ...
                        <!-- จบ 3. บุคคลอื่นที่ได้รับคำสั่งศาลให้เป็นผู้ปกครอง -->
			...
			<div id="tab2">
		        <iframe id="FAQ1" style="display: none;" height="700" frameborder="0" ></iframe>
			</div>
			<div id="tab3">
		        <iframe id="FAQ2" style="display: none;" height="700" frameborder="0" ></iframe>
			</div>
			<div id="tab4">
                <iframe id="FAQ3" style="display: none;" height="700" frameborder="0" ></iframe>
			</div>
        </div>
    </div>
    <!-- end container -->
